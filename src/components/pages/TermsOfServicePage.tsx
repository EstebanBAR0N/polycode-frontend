...
export default function TermsOfServicePage() {
  return (
    ...
    >
      <Box>
        <h1>PolyCode TERMS OF SERVICE</h1>
        Last updated [month day, year] AGREEMENT TO TERMS These Terms of Service
        constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity (“you”) and [business entity name]
        (“we,” “us” or “our”), concerning your access to and use of the [website
        name.com] website as well as any other media form, media channel, mobile
        ...
        Site, you have read, understood, and agree to be bound by all of these
        Terms of Service. If you do not agree with all of these Terms of
        Service, then you are expressly prohibited from using the Site and you
        must discontinue use immediately. Supplemental Terms of Service or
        ...
        Service at any time and for any reason. We will alert you about any
        ...
        revised Terms of Service by your continued use of the Site after the
        date such revised Terms of Service are posted. The information provided
        ...
        applicable.  These terms of service were created using Termly. Option 1:
        The Site is intended for users who are at least 18 years old. Persons
        under the age of 18 are not permitted to register for the Site. Option
        2: [The Site is intended for users who are at least 13 years of age.]
        ...
        these Terms of Service prior to you using the Site.
